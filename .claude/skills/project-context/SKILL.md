...
description: This skill should be used when the user provides a PRD, brief, bullet points, screenshots, or rough notes about a project and asks to generate a project context document. Suitable as the starting context document for any new design or build project.
---
...
**Design Owner:** [Name of the design owner if mentioned, otherwise "Not specified"]
**Product Owner:** [Name of the product owner if mentioned, otherwise "Not specified"]
**Version:** 1.0
...
## 8. User Research Insights
[Any user research mentioned in the input -- interviews, usability studies, surveys, analytics, quotes, observed behaviors. If no research is present in the input, write "Not defined in source material" and add it to the Gaps section.]
